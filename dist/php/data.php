...
$email_body = "You have received a new message from your eMarketing London website Quote Engine .\n\n"."Here are the details:\n\ Name: $first_name\n Company Name: $company \nPhone: $phone\nEmail: $email\n Message: $message

\n\n\n Here is the Quote Request: \n Service For: $service_type\n Duration: $duration\n Urgency: $urgency\n  ";

// Weekly Price range: $price_range\n Area: $area \n How urgent : $urgency \n  For how long: $timeline 

$headers = "From: noreply@eMarketing-london.co.uk\n"; // This is the email address the generated message will be from. We recommend using something like noreply@yourdomain.com.
